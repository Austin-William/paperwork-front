...
function QuizQuestion() {
    ...
    // Mock data
    const [currentId, setCurrentId] = useState<number>(mockData.questions[0].step_id);
    const [currentQuestion, setCurrentQuestion] = useState<string>(mockData.questions[0].question);
    const [questions, setQuestions] = useState<any>(mockData.questions);
    const [answer, setAnswer] = useState([{}]);
    const [underAnswer, setUnderAnswer] = useState([{}]);
    const [nextUnder, setNextUnder] = useState(-1);
