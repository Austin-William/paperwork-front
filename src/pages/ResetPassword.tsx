        ...
        <>
            ...
            <div className='ResetPassword-container'>
                ...
                <div className='ResetPassword-title-top'>{t('resetPassword.titleTop')}</div>
                    ...
                    <button className={buttonDisabled ? 'ResetPassword-submit-button disabled' : 'ResetPassword-submit-button'} aria-label='button-resetpassword' onClick={password === confirmPassword ? handleSubmit : errorSubmit}
                        disabled
