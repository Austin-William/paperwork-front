...
function ProfilePage() {
    ...
    const [username, setUsername] = useState(mockData.user_table[0].username);
    const [name, setName] = useState(mockData.user_table[0].name);
    const [firstname, setFirstname] = useState(mockData.user_table[0].firstname);
    const [language, setLanguage] = useState(mockData.user_table[0].language);
    const [age, setAge] = useState(mockData.user_table[0].age);
    const [email, setEmail] = useState(mockData.user_table[0].email);
    const [address, setAddress] = useState(mockData.user_table[0].address);
    const [phonenumber, setPhonenumber] = useState(mockData.user_table[0].number_phone);
    const [profilePicture, setProfilePicture] = useState(mockData.user_table[0].profile_picture);
    const [userProcessInfo, setUserProcessInfo] = useState(mockData.user_process);
