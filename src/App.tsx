...
function App () {
    const errorMessageAWS = "Due to a technical issue, the application may not be fully functional. It's not possible to contact us, create an user, update the data... All texts are only available in English after login. Thank you for your understanding.";

    React.useEffect(() => {
            toast.warn(errorMessageAWS, {
